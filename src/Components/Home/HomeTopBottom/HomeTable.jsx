      ...
      <div className="HomeTable">
        {Array.isArray(userTable) &&
          userTable?.map((profile, index) => (
            <div
              key={index}
              className="relative border-b-2 border-gray-300 py-4 flex gap-4 items-center px-[36px]"
            >
              <div className="left-site-table md:flex gap-5 justify-between  w-[35%]">
                {/* <!-- Profile Section --> */}
                <div className="md:flex gap-3 justify-center">
                  ...
                  {/* <!-- Username --> */}
                  <div>
                    <h1 className="text-[14px]  font-[500] text-[#46AEF7]">
                      USERNAME
                    </h1>
                    <span className="text-[14px] font-[500] text-[#46AEF7]">
                      評価 : 10
                    </span>
                  </div>
                </div>
                ...
                {/* <!-- Date Section --> */}
                <div className="md:pe-10  text-[14px] font-[500] text-[#757575] ">
                  2023-07-13 12:52
                </div>
              </div>
                  ...
                  <div className="flex space-x-2">
                    {profile?.allImage.length > 0 ? (
                      <>
                        ...
                        <div className="w-[80px] h-[80px] flex items-center justify-center bg-transparent border-[1px] border-[#E2E2E2]">
                          <h1 className="text-[10px] font-[400] text-center text-[#757575]">
                            {" "}
                            + ({profile?.moreItemNumber} <br /> more items)
                          </h1>
                        </div>
                      </>
                    ) : (
                      <div className="flex  absolute top-[15px]">
                        <h1 className="text-[15px] font-[500] text-[#757575]">
                          {profile?.arrayofData}
                        </h1>
                      </div>
                    )}
