  ...
  return (
    ...
    <div className="md:mt-[17px] home-page maxWidth mx-auto h-[100vh] ">
      <div className="bg-[#fff] md:bg-transparent pt-[15px] md:pt-[0px] px-[15px] md:px-[0]">
        {/*------------ Start Home First Buttons Section ------------ */}
        ...
        {/*------------ Small Device First Buttons Section ------------ */}
        <div className="md:hidden flex">
          <CategorySlider HomeTopButton={HomeTopButton} />
        </div>

        {/*------------  2nd Button Home Section -------------- */}
              ...
              <div className="flex justify-center items-center gap-1 text-[10px] md:text-[16px] font-[500]">
                {index === 0 && (
                  <svg
                    ...
                    className="w-[10px] h-[10px] md:w-[18px] md:h-[16px]"
                    viewBox="0 0 19 19"
                    fill="none"
                  >
                    <path
                ...
                {index === 2 && (
                  <IoSettingsOutline className="w-[13px] h-[13px] md:w-[18px] md:h-[18px]" />
                )}
                {button.name}
              </div>
            </button>
